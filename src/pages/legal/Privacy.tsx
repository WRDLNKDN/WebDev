...
import { PrivacyPolicyFooterSections } from './privacy/PrivacyPolicyFooterSections';
import { LegalDocumentShell } from './LegalDocumentShell';

const CONTACT_EMAIL = 'info@wrdlnkdn.com';

export const Privacy = () => (
  <LegalDocumentShell title="Privacy Policy (Public Notice)">
    <Typography variant="body1" paragraph>
      This Privacy Policy is provided as a public notice describing how
      information is collected, used, and handled when accessing or using the
      WRDLNKDN website and platform.
    </Typography>
    <Typography variant="body1" paragraph>
    ...
    <Typography variant="body1" paragraph>
      If you do not agree to the practices described below, do not access or use
      the Service.
    </Typography>
    ...
    <Typography variant="body2" paragraph>
      This Privacy Policy explains the data practices for the WRDLNKDN platform.
    </Typography>
    <Typography variant="body2" paragraph>
    ...
    <Typography variant="body2" paragraph>
      Drake Svc LLC is the data controller for purposes of applicable privacy
      and data protection laws.
    </Typography>
    <Typography variant="body2" paragraph>
      This notice applies to public visitors, registered users, contributors,
      and participants interacting with the Service at https://wrdlnkdn.com
    </Typography>
    ...
    <Box component="ul" sx={{ pl: 3, mb: 2 }}>
      <li>
        Information you voluntarily provide, such as account details, profile
        information, or content submissions
      </li>
      <li>Communications you send to us directly</li>
      <li>
        Technical information generated through normal website operation, such
        as: IP address, browser type, device type, and basic usage data
      </li>
    </Box>
    <Typography variant="body2" paragraph>
    ...
    <Box component="ul" sx={{ pl: 3, mb: 2 }}>
      ...
      <li>
        Our legitimate interests in operating and improving the Service, where
    ...
    <Typography variant="body2" paragraph>
      You may adjust browser settings to limit or disable cookies, though some
    ...
    <Box component="ul" sx={{ pl: 3, mb: 2 }}>
      ...
      <li>
        To protect the rights, safety, or integrity of the Service and its users
      </li>
    </Box>
    <Typography variant="body2" paragraph>
    ...
    <Typography variant="body2" paragraph>
      Some content you submit, such as profile information or contributions, may
      be publicly visible by design.
    </Typography>
    <Typography variant="body2" paragraph>
      You are responsible for the information you choose to make public through
      the Service.
    </Typography>
    ...
    <Typography variant="body2" paragraph>
      Content or accounts may be removed upon request where reasonably feasible,
      subject to operational and legal constraints.
    </Typography>
    ...
    <Typography variant="body2" paragraph>
      However, no system can be guaranteed to be completely secure, and use of
    ...
    <Box component="ul" sx={{ pl: 3, mb: 2 }}>
      ...
      <li>
        Limit use or disclosure of sensitive personal information, if applicable
      </li>
    ...
    <Typography variant="body2" paragraph>
      Requests may be submitted using the contact information below. We may need
    ...
    <PrivacyPolicyFooterSections contactEmail={CONTACT_EMAIL} />
  </LegalDocumentShell>
);
