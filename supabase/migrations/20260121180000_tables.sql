-- tables.sql
-- Canonical consolidated tables file.
-- Merges: 20260121180000_tables.sql + 20260401123000_tables.sql (media_assets, media_asset_events).
-- Idempotent: does NOT drop tables or data.
...
-- ============================================================
-- media_assets + media_asset_events
-- (from 20260401123000_tables.sql — merged into canonical tables file)
-- ============================================================
...
-- Additive columns (idempotent: ADD COLUMN IF NOT EXISTS; no data deleted)
