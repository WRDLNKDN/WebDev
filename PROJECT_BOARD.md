<!-- GitHub Project Board setup instructions for WeirdLinkedIn -->

1. Go to your GitHub repository for WeirdLinkedIn.
2. Click on the 'Projects' tab.
3. Create a new project board (e.g., 'WeirdLinkedIn Board').
