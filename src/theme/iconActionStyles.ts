...
export const glassDangerIconButtonSx: SxProps<Theme> = {
  ...
  boxShadow:
    '0 14px 28px rgba(4,10,25,0.42), inset 0 1px 0 rgba(255,255,255,0.12), 0 0 0 1px rgba(255,255,255,0.04)',
  ...
  '&:hover': {
    ...
    boxShadow:
      '0 18px 34px rgba(4,10,25,0.46), inset 0 1px 0 rgba(255,255,255,0.16), 0 0 18px rgba(96,208,255,0.18)',
  },
};
