...
export const Guidelines = () => (
  <LegalDocumentShell title="Community Guidelines">
    <Typography variant="body1" paragraph>
      These Community Guidelines are provided as a public notice outlining
      expected behavior and participation standards for the WRDLNKDN platform.
    </Typography>
    <Typography variant="body1" paragraph>
    ...
    <Typography variant="body2" paragraph>
      These guidelines describe how community members are expected to interact
      with one another and with the platform. They are intended to set clear
      expectations while allowing room for creativity, humor, and diverse
      perspectives.
    </Typography>
    ...
    <Typography variant="body2" paragraph>
      These guidelines apply to all interactions on WRDLNKDN, including but not
      limited to:
    </Typography>
    ...
    <Typography variant="body2" paragraph>
      Some content may be removed even if it does not violate a specific rule,
      if it undermines the community&apos;s purpose or well-being.
    </Typography>
