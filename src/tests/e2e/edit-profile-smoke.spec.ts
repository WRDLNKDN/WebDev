...
test.describe('Edit Profile smoke', () => {
  // fixme: E2E auth/session stub causes SYSTEM_HALT on dashboard; fix stubs or run against real backend
  test.fixme(
    'opens Edit Profile from Dashboard, changes bio, save closes dialog',
    async ({ page, context }) => {
