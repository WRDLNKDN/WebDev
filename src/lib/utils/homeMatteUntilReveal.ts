/**
 * When true (default), Layout uses a solid matte on `/` only while the hero video
 * is playing; after copy is revealed, the normal synthwave / photo background returns.
