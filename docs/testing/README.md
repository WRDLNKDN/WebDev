...
## Optional coverage (not yet implemented)

- _(None at this time. Directory Manage/Disconnect/Block and Edit Profile smoke
  are covered by `directory-manage.spec.ts` and `edit-profile-smoke.spec.ts`.)_
