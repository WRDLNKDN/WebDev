/**
 * Local declarations for specific @mui/icons-material exports that do not
 * ship bundled TypeScript types in this environment.
 *
 * If TS7016 appears for another icon, add a new `declare module` here.
 */
